...
Original file is located at
    https://colab.research.google.com/drive/1jcpBAcgpiCp3Y-GuoJDHobzjVcKtobhx
...
!convert husky.png -resize 2000x2000 bighusky.png
...
Image(filename="bighusky.png")

!convert husky.png -size 1000x1000 sizedhusky.png
...
!montage -frame 5  -shadow  -geometry 500x500 -tile 2x2 bwhusky*png bmontbwhusky.png
Image(filename="bmontbwhusky.png", width=900)
...
#Image(filename="binhuskyanim.gif", width=600)

!convert husky.png -set colorspace Gray -separate -average huskygray.png
Image(filename="huskygray.png", width=800)
...
#Image(filename="binhuskyanimbw.gif", width=600)
...
#Image(filename="dither_huskyanim.gif", width=800)
...
#Image(filename="huskyanim_replcolors.gif", width=800)
...
!convert huskycyphtxt.png -decipher passphrase.txt huskydeciph.png
Image(filename="huskydeciph.png", width=900)
...
Image(filename="huskycspmont.jpg", width=900)
